...
<template>
  <main class="min-h-screen bg-gray-900 text-white p-4">
    ...
    <!-- No Results Message -->
    <div
      v-else-if="!loading && characters.length === 0"
      class="max-w-7xl mx-auto text-center p-8 bg-gray-800 rounded-lg shadow-lg animate-fade-in"
    >
      <svg
      ...
      <h3 class="text-xl font-semibold mb-2 text-green-400">Nenhum personagem encontrado</h3>
      <p class="text-gray-400">
        Tente ajustar seus filtros de busca para encontrar outros personagens.
      </p>
    </div>
